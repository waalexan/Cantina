...
if(true)
{
	...
	$sql = "INSERT INTO `vendidos` VALUES ('".$date."','".$_POST['barcode']."','".$_POST['produto']."','".$_POST['categoria']."','".$_POST['preco']."','".$_POST['qtd']."','".$total."','".$id."','".$_SESSION['clientecode']."')";
    $conn->query($sql);

	$sql = "INSERT INTO `venda` VALUES ('".$date."','".$_POST['barcode']."','".$_POST['produto']."','".$_POST['categoria']."','".$_POST['preco']."','".$_POST['qtd']."','".$total."','".$_SESSION['clientecode']."')";
